...
(1, 15, 2, 'A', '08/27/2019', '12/30/2019'),
...
(1, 'Abdullah', 'abdullahayoub7842@gmail.com', '202cb962ac59075b964b07152d234b70', 'Malir City Karachi'),
(2, 'suha', 'suha@g.c', '202cb962ac59075b964b07152d234b70', 'Malir City Karachi'),
(3, 'shakir', 'shakir@g.c', '202cb962ac59075b964b07152d234b70', 'Malir City Karachi'),
(4, 'asad', 'asad@gmail.com', '202cb962ac59075b964b07152d234b70', 'Malir City Karachi');
...
--
ALTER TABLE `take_challenge`
  MODIFY `tc_Id` int(20) NOT NULL AUTO_INCREMENT;
